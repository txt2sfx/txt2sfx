...
const MANIFEST: readonly string[] = [
  ...
  'machine-hum',
  'campfire-loop',
  /* The second pass, chosen against what freesound.org's own download counts say an
     indie game actually reaches for: firearms and magic were the two largest holes —
     the catalog could shoot a laser but not a pistol, and had no fantasy vocabulary at
     all — followed by melee, water, an 8-bit set, and the loops a level needs behind
     everything else. */
  'gun-pistol',
  'gun-shotgun',
  'gun-rifle-burst',
