...
<p><sub><b>Studio</b> — one sound: the recipe, its waveform, a lane per layer, a knob per <code>~slot</code>, and the JavaScript it exports. The warning under the source (<code>export is 2196 B, over the 1024 B budget</code>) is the compiler reporting what a four-layer recipe cost — a report, not a gate.</sub></p>
</td>
</tr>
<tr>
<td width="50%" valign="top">
